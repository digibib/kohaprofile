...
=item * Save the data about tests in a database, so we can build up lots of data over time

=item * Create a Dancer-app or something similar that can query the database and display data dynamically
